...
public class ListingController {
  ...
  public ResponseEntity<ListingResponse> createListing(
      @RequestBody ListingRequest request, Authentication authentication) {
  ...
  public ResponseEntity<Page<ListingResponse>> filterListings(
    ...
    Page<ListingResponse> listings =
        listingService.filterListings(filter, page, size, sortBy, direction);
    return ResponseEntity.ok(listings);
  }
  ...
  public ResponseEntity<ListingResponse> updateListing(
      @PathVariable Long id, @RequestBody ListingRequest request, Authentication authentication) {
