...
class ListingServiceTest {
    ...
    void getUserListings_UserNotFound_ThrowsException() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> listingService.getUserListings("unknown@example.com"));
    ...
    void deleteListing_NotOwner_ThrowsException() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> listingService.deleteListing(1L, "other@example.com"));
    ...
    void deleteListing_ListingNotFound_ThrowsException() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> listingService.deleteListing(999L, "test@example.com"));
    ...
    void filterListings_Success() {
        ...
        Page<ListingResponse> result = listingService.filterListings(testFilter, 0, 10, "createdAt", "desc");
