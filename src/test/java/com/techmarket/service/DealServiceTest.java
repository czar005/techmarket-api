...
class DealServiceTest {
    ...
    void createPurchaseRequest_ListingNotFound_ThrowsException() {
        ...
        assertThrows(RuntimeException.class, () -> dealService.createPurchaseRequest(req, "buyer@test.com"));
    }
    ...
    void createPurchaseRequest_BuyerIsSeller_ThrowsException() {
        ...
        assertThrows(RuntimeException.class, () -> dealService.createPurchaseRequest(req, "same@test.com"));
    }
